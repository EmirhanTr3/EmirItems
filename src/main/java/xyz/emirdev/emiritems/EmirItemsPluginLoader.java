...
public class EmirItemsPluginLoader implements PluginLoader {
    ...
    public void classloader(PluginClasspathBuilder classpathBuilder) {
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("io.github.revxrsal:lamp.common:4.0.0-rc.2"), null));
        resolver.addDependency(new Dependency(new DefaultArtifact("io.github.revxrsal:lamp.bukkit:4.0.0-rc.2"), null));
